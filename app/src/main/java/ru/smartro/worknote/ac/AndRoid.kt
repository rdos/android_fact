...
class AndRoid {
    ...
    companion object {
        private var mInstance: ru.smartro.worknote.ac.AndRoid? = null
        //todo: getService(id here)
        fun getService(): LocationManager {
            if (ru.smartro.worknote.ac.AndRoid.Companion.mInstance == null) {
                ru.smartro.worknote.ac.AndRoid.Companion.mInstance = ru.smartro.worknote.ac.AndRoid()
            }
            return ru.smartro.worknote.ac.AndRoid.Companion.mInstance!!.getLocationService()
...
//            criteria.isCostAllowed = false
        ...
        fun getProviderName(): String {
            return ru.smartro.worknote.ac.AndRoid.Companion.getService()
                .getBestProvider(ru.smartro.worknote.ac.AndRoid.Companion.getCriterial(), true)?: LocationManager.NETWORK_PROVIDER
        }

        fun getProviderNameS(): MutableList<String> {
            return ru.smartro.worknote.ac.AndRoid.Companion.getService().allProviders
        }
