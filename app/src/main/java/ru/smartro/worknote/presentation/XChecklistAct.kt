...
import ru.smartro.worknote.log.awORKOLDs.extensions.showDlgLogout
...
class XChecklistAct: AAct() {
    ...
    */
    ...
    class ChecklistViewModel(app: Application) : ru.smartro.worknote.andPOintD.AViewModel(app) {
