package ru.smartro.worknote.presentation.andPOintD.Audio
...
//        p_callback.onCancelVoiceComment()
    ...
    override fun onTick(millisUntilFinished: Long) {
        ...
        p_callback.onVoiceCommentShowForUser(volume, timeInMS, INTERVAL_IN_MS)
    ...
    interface IVoiceComment {
        ...
        /**VT, sorry!!! onHandleVoiceComment()  */
        fun onVoiceCommentShowForUser(volume: Int, timeInMS: Long, interValInMS: Long)
